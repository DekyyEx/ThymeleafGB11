...
public class TimerAspect {
    ...
    @Pointcut("@annotation(com.example.DZNine.Aspect.Timer)")
    public void timesheetServiceMethodsPointcut() {
    }

    @Pointcut("@within(com.example.DZNine.Aspect.Timer)")
    ...
    public Object around(ProceedingJoinPoint proceedingJoinPoint) throws Throwable {
        ...
        try {
            ...
            String logMessage = String.format("Around method: %s, Time taken: %d ms",
                    proceedingJoinPoint.getSignature().getName(), timeTaken);
