...
public class LoggingAspect {
    ...
    @Pointcut("execution(* org.example.springmvcthymeleaf.service.TimesheetService.*(..))")
    public void timesheetServiceMethodsPointcut() {
        log.info("TimesheetService pointcut");
    }

    @Before("execution(* org.example.springmvcthymeleaf.service.TimesheetService.findById(Long))")
    ...
    public void afterThrowing(JoinPoint joinPoint, Exception exception) {
        logArguments(joinPoint);
        log.info("AfterThrowing method: {} , Exception : {}", joinPoint.getSignature().getName(), exception.getClass().getName());
    }
